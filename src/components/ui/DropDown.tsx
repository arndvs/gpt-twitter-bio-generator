...
export default function DropDown({ vibe, setVibe }: DropDownProps) {
  return (
    <Menu as="div" className="relative block w-full text-left">
      <div>
        <Menu.Button className="inline-flex items-center justify-between w-full px-4 py-2 border rounded-md shadow-sm text-slate-300 border-slate-500/30 bg-zinc-900/70 hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-black">
          {vibe}
          <ChevronUpIcon
